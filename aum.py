"""
Copied from Seo Yeon Park's repo:
https://github.com/seoyeon-p/MixUp-Guided-by-AUM-and-Saliency-Map 
"""
...
class AUMCalculator():
  ...
  def update(self, logits: torch.Tensor, targets: torch.Tensor, 
              sample_ids: List[sample_identifier], grads: List) -> Dict[sample_identifier, AUMRecord]:
    """
